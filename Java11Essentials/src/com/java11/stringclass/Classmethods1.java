package com.java11.stringclass;
...
public class Classmethods1 {
	...
	public static void main(String[] args) {
		...
		System.out.println("Comparison of Thomas with THOMAS using equals ignoring case:- "
				+ thirdString.equalsIgnoreCase(fourthString));
		...
		/*
		 * if s1 and s2 are two strings which are to be compared if s1 == s2 then output
		 * is 0 if s1 > s2 then output is 1 if s1 < s2 then output is -1
		 */

		System.out
				.println("Comparison of Thomas and Thomas using comapreTo :- " + (thirdString.compareTo(fifthString)));
		System.out.println(
				"Comparison of Thomas and RudolfShelby using compareTo :- " + (thirdString.compareTo("RudolfShelby")));
